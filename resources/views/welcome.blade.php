...
setInterval(updateTime, 1000);
    ...
    <body class="antialiased">
        ...
        <form action="">
            ...
            <input type="date" id="set-date" name="date" class="form-control form-control-lg input-lg" required placeholder="Select a date">
               
            </fieldset>
            <fieldset class="form-group position-relative has-icon-left">
                <input type="time" id="set-time" name="time" class="form-control form-control-lg input-lg rounded-lg" required placeholder="Select a time">
            </fieldset>
       </form>  
      </div>
    </body>
